...
struct qt_meta_stringdata_UrlLauncher_t {
    QByteArrayData data[6];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UrlLauncher_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UrlLauncher_t qt_meta_stringdata_UrlLauncher = {
    {
QT_MOC_LITERAL(0, 0, 11), // "UrlLauncher"
QT_MOC_LITERAL(1, 12, 12), // "launchUrlExt"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "link"
QT_MOC_LITERAL(4, 31, 8), // "QWidget*"
QT_MOC_LITERAL(5, 40, 6) // "parent"

    },
    "UrlLauncher\0launchUrlExt\0\0link\0QWidget*\0"
    "parent"
};
...
static const uint qt_meta_data_UrlLauncher[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       1,    1,   47,    2, 0x2a /* Public | MethodCloned */,
...
const QMetaObject UrlLauncher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UrlLauncher.data,
      qt_meta_data_UrlLauncher,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UrlLauncher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UrlLauncher.stringdata))
