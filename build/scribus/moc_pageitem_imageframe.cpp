...
struct qt_meta_stringdata_PageItem_ImageFrame_t {
    QByteArrayData data[1];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PageItem_ImageFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PageItem_ImageFrame_t qt_meta_stringdata_PageItem_ImageFrame = {
    {
QT_MOC_LITERAL(0, 0, 19) // "PageItem_ImageFrame"
...
const QMetaObject PageItem_ImageFrame::staticMetaObject = {
    { &PageItem::staticMetaObject, qt_meta_stringdata_PageItem_ImageFrame.data,
      qt_meta_data_PageItem_ImageFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PageItem_ImageFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PageItem_ImageFrame.stringdata))
