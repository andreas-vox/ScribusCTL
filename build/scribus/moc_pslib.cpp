...
struct qt_meta_stringdata_PSLib_t {
    QByteArrayData data[3];
    char stringdata[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PSLib_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PSLib_t qt_meta_stringdata_PSLib = {
    {
QT_MOC_LITERAL(0, 0, 5), // "PSLib"
QT_MOC_LITERAL(1, 6, 15), // "cancelRequested"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "PSLib\0cancelRequested\0"
};
...
const QMetaObject PSLib::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PSLib.data,
      qt_meta_data_PSLib,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PSLib::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PSLib.stringdata))
