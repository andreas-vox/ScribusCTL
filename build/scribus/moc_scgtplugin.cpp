...
struct qt_meta_stringdata_ScGTPlugin_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScGTPlugin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScGTPlugin_t qt_meta_stringdata_ScGTPlugin = {
    {
QT_MOC_LITERAL(0, 0, 10) // "ScGTPlugin"
...
const QMetaObject ScGTPlugin::staticMetaObject = {
    { &ScPlugin::staticMetaObject, qt_meta_stringdata_ScGTPlugin.data,
      qt_meta_data_ScGTPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScGTPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScGTPlugin.stringdata))
...
struct qt_meta_stringdata_ScGTFileDialog_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScGTFileDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScGTFileDialog_t qt_meta_stringdata_ScGTFileDialog = {
    {
QT_MOC_LITERAL(0, 0, 14) // "ScGTFileDialog"
...
const QMetaObject ScGTFileDialog::staticMetaObject = {
    { &CustomFDialog::staticMetaObject, qt_meta_stringdata_ScGTFileDialog.data,
      qt_meta_data_ScGTFileDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ScGTFileDialog.stringdata))
