...
#include "../../../scribus/ui/shadebutton.h"
...
struct qt_meta_stringdata_ShadeButton_t {
    QByteArrayData data[5];
    char stringdata[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ShadeButton_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ShadeButton_t qt_meta_stringdata_ShadeButton = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ShadeButton"
QT_MOC_LITERAL(1, 12, 8), // "setShade"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8), // "QAction*"
QT_MOC_LITERAL(4, 31, 3) // "act"

    },
    "ShadeButton\0setShade\0\0QAction*\0act"
};
...
const QMetaObject ShadeButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_ShadeButton.data,
      qt_meta_data_ShadeButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ShadeButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShadeButton.stringdata))
