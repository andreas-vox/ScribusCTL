...
#include "../../../scribus/ui/contextmenu.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ContextMenu_t, stringdata) + ofs \
...
const QMetaObject ContextMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_ContextMenu.data,
      qt_meta_data_ContextMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ContextMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ContextMenu.stringdata))
