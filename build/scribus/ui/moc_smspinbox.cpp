...
#include "../../../scribus/ui/smspinbox.h"
...
struct qt_meta_stringdata_SMSpinBox_t {
    QByteArrayData data[3];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMSpinBox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMSpinBox_t qt_meta_stringdata_SMSpinBox = {
    {
QT_MOC_LITERAL(0, 0, 9), // "SMSpinBox"
QT_MOC_LITERAL(1, 10, 16), // "slotValueChanged"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "SMSpinBox\0slotValueChanged\0"
};
...
const QMetaObject SMSpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata_SMSpinBox.data,
      qt_meta_data_SMSpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SMSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMSpinBox.stringdata))
