...
#include "../../../scribus/ui/smstyleselect.h"
...
struct qt_meta_stringdata_SMStyleSelect_t {
    QByteArrayData data[4];
    char stringdata[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMStyleSelect_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMStyleSelect_t qt_meta_stringdata_SMStyleSelect = {
    {
QT_MOC_LITERAL(0, 0, 13), // "SMStyleSelect"
QT_MOC_LITERAL(1, 14, 12), // "styleChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9) // "pbPressed"

    },
    "SMStyleSelect\0styleChanged\0\0pbPressed"
};
...
const QMetaObject SMStyleSelect::staticMetaObject = {
    { &StyleSelect::staticMetaObject, qt_meta_stringdata_SMStyleSelect.data,
      qt_meta_data_SMStyleSelect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SMStyleSelect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMStyleSelect.stringdata))
