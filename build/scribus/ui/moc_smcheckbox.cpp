...
#include "../../../scribus/ui/smcheckbox.h"
...
struct qt_meta_stringdata_SMCheckBox_t {
    QByteArrayData data[3];
    char stringdata[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMCheckBox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMCheckBox_t qt_meta_stringdata_SMCheckBox = {
    {
QT_MOC_LITERAL(0, 0, 10), // "SMCheckBox"
QT_MOC_LITERAL(1, 11, 16), // "slotStateChanged"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "SMCheckBox\0slotStateChanged\0"
};
...
const QMetaObject SMCheckBox::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata_SMCheckBox.data,
      qt_meta_data_SMCheckBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SMCheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMCheckBox.stringdata))
