...
#include "../../../scribus/ui/fontreplacedialog.h"
...
struct qt_meta_stringdata_FontReplaceDialog_t {
    QByteArrayData data[3];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FontReplaceDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FontReplaceDialog_t qt_meta_stringdata_FontReplaceDialog = {
    {
QT_MOC_LITERAL(0, 0, 17), // "FontReplaceDialog"
QT_MOC_LITERAL(1, 18, 7), // "leaveOK"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "FontReplaceDialog\0leaveOK\0"
};
...
const QMetaObject FontReplaceDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FontReplaceDialog.data,
      qt_meta_data_FontReplaceDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FontReplaceDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FontReplaceDialog.stringdata))
