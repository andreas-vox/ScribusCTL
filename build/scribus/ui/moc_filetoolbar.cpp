/****************************************************************************
** Meta object code from reading C++ file 'filetoolbar.h'
**
...
#error "The header file 'filetoolbar.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileToolBar_t, stringdata) + ofs \
...
const QMetaObject FileToolBar::staticMetaObject = {
    { &ScToolBar::staticMetaObject, qt_meta_stringdata_FileToolBar.data,
      qt_meta_data_FileToolBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileToolBar.stringdata))
        return static_cast<void*>(const_cast< FileToolBar*>(this));
