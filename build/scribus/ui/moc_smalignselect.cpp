...
#include "../../../scribus/ui/smalignselect.h"
...
struct qt_meta_stringdata_SMAlignSelect_t {
    QByteArrayData data[4];
    char stringdata[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMAlignSelect_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMAlignSelect_t qt_meta_stringdata_SMAlignSelect = {
    {
QT_MOC_LITERAL(0, 0, 13), // "SMAlignSelect"
QT_MOC_LITERAL(1, 14, 12), // "styleChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9) // "pbPressed"

    },
    "SMAlignSelect\0styleChanged\0\0pbPressed"
};
...
const QMetaObject SMAlignSelect::staticMetaObject = {
    { &AlignSelect::staticMetaObject, qt_meta_stringdata_SMAlignSelect.data,
      qt_meta_data_SMAlignSelect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SMAlignSelect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMAlignSelect.stringdata))
