...
struct qt_meta_stringdata_PDFToolBar_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PDFToolBar_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PDFToolBar_t qt_meta_stringdata_PDFToolBar = {
    {
QT_MOC_LITERAL(0, 0, 10) // "PDFToolBar"
...
const QMetaObject PDFToolBar::staticMetaObject = {
    { &ScToolBar::staticMetaObject, qt_meta_stringdata_PDFToolBar.data,
      qt_meta_data_PDFToolBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PDFToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PDFToolBar.stringdata))
