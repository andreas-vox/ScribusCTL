...
const QMetaObject Query::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Query.data,
...
void *Query::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Query.stringdata))
