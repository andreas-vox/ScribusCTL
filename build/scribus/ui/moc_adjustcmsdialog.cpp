...
#include "../../../scribus/ui/adjustcmsdialog.h"
...
struct qt_meta_stringdata_AdjustCmsDialog_t {
    QByteArrayData data[1];
    char stringdata[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AdjustCmsDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AdjustCmsDialog_t qt_meta_stringdata_AdjustCmsDialog = {
    {
QT_MOC_LITERAL(0, 0, 15) // "AdjustCmsDialog"
...
const QMetaObject AdjustCmsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AdjustCmsDialog.data,
      qt_meta_data_AdjustCmsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AdjustCmsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdjustCmsDialog.stringdata))
