...
#include "../../../scribus/ui/pluginmanagerprefsgui.h"
...
struct qt_meta_stringdata_PluginManagerPrefsGui_t {
    QByteArrayData data[3];
    char stringdata[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PluginManagerPrefsGui_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PluginManagerPrefsGui_t qt_meta_stringdata_PluginManagerPrefsGui = {
    {
QT_MOC_LITERAL(0, 0, 21), // "PluginManagerPrefsGui"
QT_MOC_LITERAL(1, 22, 5), // "apply"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "PluginManagerPrefsGui\0apply\0"
};
...
const QMetaObject PluginManagerPrefsGui::staticMetaObject = {
    { &PrefsPanel::staticMetaObject, qt_meta_stringdata_PluginManagerPrefsGui.data,
      qt_meta_data_PluginManagerPrefsGui,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PluginManagerPrefsGui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PluginManagerPrefsGui.stringdata))
