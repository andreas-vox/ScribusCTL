...
#include "../../../scribus/ui/fontlistview.h"
...
struct qt_meta_stringdata_FontListView_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FontListView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FontListView_t qt_meta_stringdata_FontListView = {
    {
QT_MOC_LITERAL(0, 0, 12) // "FontListView"
...
const QMetaObject FontListView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_FontListView.data,
      qt_meta_data_FontListView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FontListView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FontListView.stringdata))
