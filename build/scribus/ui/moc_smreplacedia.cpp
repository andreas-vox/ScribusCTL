...
#include "../../../scribus/ui/smreplacedia.h"
...
struct qt_meta_stringdata_SMRowWidget_t {
    QByteArrayData data[1];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMRowWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMRowWidget_t qt_meta_stringdata_SMRowWidget = {
    {
QT_MOC_LITERAL(0, 0, 11) // "SMRowWidget"
...
const QMetaObject SMRowWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SMRowWidget.data,
      qt_meta_data_SMRowWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SMRowWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMRowWidget.stringdata))
...
struct qt_meta_stringdata_SMReplaceDia_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SMReplaceDia_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMReplaceDia_t qt_meta_stringdata_SMReplaceDia = {
    {
QT_MOC_LITERAL(0, 0, 12) // "SMReplaceDia"
...
const QMetaObject SMReplaceDia::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SMReplaceDia.data,
      qt_meta_data_SMReplaceDia,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_SMReplaceDia.stringdata))
