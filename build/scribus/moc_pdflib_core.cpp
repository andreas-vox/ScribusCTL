...
struct qt_meta_stringdata_PDFLibCore_t {
    QByteArrayData data[3];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PDFLibCore_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PDFLibCore_t qt_meta_stringdata_PDFLibCore = {
    {
QT_MOC_LITERAL(0, 0, 10), // "PDFLibCore"
QT_MOC_LITERAL(1, 11, 15), // "cancelRequested"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "PDFLibCore\0cancelRequested\0"
};
...
const QMetaObject PDFLibCore::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PDFLibCore.data,
      qt_meta_data_PDFLibCore,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PDFLibCore::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PDFLibCore.stringdata))
