...
struct qt_meta_stringdata_PageItem_TextFrame_t {
    QByteArrayData data[3];
    char stringdata[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PageItem_TextFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PageItem_TextFrame_t qt_meta_stringdata_PageItem_TextFrame = {
    {
QT_MOC_LITERAL(0, 0, 18), // "PageItem_TextFrame"
QT_MOC_LITERAL(1, 19, 20), // "slotInvalidateLayout"
...
const QMetaObject PageItem_TextFrame::staticMetaObject = {
    { &PageItem::staticMetaObject, qt_meta_stringdata_PageItem_TextFrame.data,
      qt_meta_data_PageItem_TextFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PageItem_TextFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PageItem_TextFrame.stringdata))
