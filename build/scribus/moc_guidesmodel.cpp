...
struct qt_meta_stringdata_GuidesModel_t {
    QByteArrayData data[3];
    char stringdata[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GuidesModel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GuidesModel_t qt_meta_stringdata_GuidesModel = {
    {
QT_MOC_LITERAL(0, 0, 11), // "GuidesModel"
QT_MOC_LITERAL(1, 12, 12), // "valueChanged"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "GuidesModel\0valueChanged\0"
};
...
void GuidesModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GuidesModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GuidesModel::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GuidesModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_GuidesModel.data,
      qt_meta_data_GuidesModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GuidesModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GuidesModel.stringdata))
