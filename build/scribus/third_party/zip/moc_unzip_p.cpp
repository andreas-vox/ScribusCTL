...
#include "../../../../scribus/third_party/zip/unzip_p.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UnzipPrivate_t, stringdata) + ofs \
...
void *UnzipPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UnzipPrivate.stringdata))
