...
struct qt_meta_stringdata_PageItem_PolyLine_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PageItem_PolyLine_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PageItem_PolyLine_t qt_meta_stringdata_PageItem_PolyLine = {
    {
QT_MOC_LITERAL(0, 0, 17) // "PageItem_PolyLine"
...
const QMetaObject PageItem_PolyLine::staticMetaObject = {
    { &PageItem::staticMetaObject, qt_meta_stringdata_PageItem_PolyLine.data,
      qt_meta_data_PageItem_PolyLine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PageItem_PolyLine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PageItem_PolyLine.stringdata))
