...
QT_MOC_LITERAL(1, 10, 6), // "Coords"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 1), // "x"
QT_MOC_LITERAL(4, 20, 1) // "y"

    },
    "Navigator\0Coords\0\0x\0y"
};
...
void Navigator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Coords((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Navigator::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Navigator::Coords)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Navigator::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Navigator.data,
...
// SIGNAL 0
void Navigator::Coords(double _t1, double _t2)
{
