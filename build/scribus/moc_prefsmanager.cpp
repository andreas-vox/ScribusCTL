...
struct qt_meta_stringdata_PrefsManager_t {
    QByteArrayData data[4];
    char stringdata[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PrefsManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PrefsManager_t qt_meta_stringdata_PrefsManager = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PrefsManager"
QT_MOC_LITERAL(1, 13, 12), // "prefsChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 14) // "languageChange"

    },
    "PrefsManager\0prefsChanged\0\0languageChange"
};
...
void PrefsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PrefsManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PrefsManager::prefsChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PrefsManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PrefsManager.data,
      qt_meta_data_PrefsManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PrefsManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PrefsManager.stringdata))
