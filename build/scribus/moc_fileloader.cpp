...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileLoader_t, stringdata) + ofs \
...
const QMetaObject FileLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileLoader.data,
      qt_meta_data_FileLoader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileLoader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileLoader.stringdata))
        return static_cast<void*>(const_cast< FileLoader*>(this));
