...
struct qt_meta_stringdata_DocInfos_t {
    QByteArrayData data[1];
    char stringdata[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DocInfos_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DocInfos_t qt_meta_stringdata_DocInfos = {
    {
QT_MOC_LITERAL(0, 0, 8) // "DocInfos"
...
const QMetaObject DocInfos::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_DocInfos.data,
      qt_meta_data_DocInfos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DocInfos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DocInfos.stringdata))
