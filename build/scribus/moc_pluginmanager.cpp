...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PluginManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "PluginManager\0languageChange\0"
};
...
void *PluginManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PluginManager.stringdata))
