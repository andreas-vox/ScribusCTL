...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ActionManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 24), // "handleMultipleSelections"
QT_MOC_LITERAL(4, 55, 10) // "isMultiple"

    },
    "ActionManager\0languageChange\0\0"
    "handleMultipleSelections\0isMultiple"
};
...
void ActionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleMultipleSelections((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ActionManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ActionManager.data,
      qt_meta_data_ActionManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ActionManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ActionManager.stringdata))
