...
#include "../../../../scribus/plugins/picbrowser/multicombobox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_multiCombobox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_multiCombobox_t qt_meta_stringdata_multiCombobox = {
    {
QT_MOC_LITERAL(0, 0, 13), // "multiCombobox"
QT_MOC_LITERAL(1, 14, 17), // "checkstateChanged"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "multiCombobox\0checkstateChanged\0"
};
...
void multiCombobox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (multiCombobox::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&multiCombobox::checkstateChanged)) {
                *result = 0;
            }
        }
    }
...
void *multiCombobox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_multiCombobox.stringdata))
...
// SIGNAL 0
void multiCombobox::checkstateChanged(int _t1)
{
