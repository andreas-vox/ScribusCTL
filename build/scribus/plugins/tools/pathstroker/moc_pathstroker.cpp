...
struct qt_meta_stringdata_PathStrokerPlugin_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PathStrokerPlugin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PathStrokerPlugin_t qt_meta_stringdata_PathStrokerPlugin = {
    {
QT_MOC_LITERAL(0, 0, 17) // "PathStrokerPlugin"
...
const QMetaObject PathStrokerPlugin::staticMetaObject = {
    { &ScActionPlugin::staticMetaObject, qt_meta_stringdata_PathStrokerPlugin.data,
      qt_meta_data_PathStrokerPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PathStrokerPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PathStrokerPlugin.stringdata))
