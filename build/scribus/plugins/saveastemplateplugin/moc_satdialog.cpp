...
struct qt_meta_stringdata_SATDialog_t {
    QByteArrayData data[3];
    char stringdata[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SATDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SATDialog_t qt_meta_stringdata_SATDialog = {
    {
QT_MOC_LITERAL(0, 0, 9), // "SATDialog"
QT_MOC_LITERAL(1, 10, 13), // "detailClicked"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "SATDialog\0detailClicked\0"
};
...
const QMetaObject SATDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SATDialog.data,
      qt_meta_data_SATDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SATDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SATDialog.stringdata))
        return static_cast<void*>(const_cast< SATDialog*>(this));
    if (!strcmp(_clname, "Ui::SATDialogBase"))
        return static_cast< Ui::SATDialogBase*>(const_cast< SATDialog*>(this));
