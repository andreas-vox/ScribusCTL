...
struct qt_meta_stringdata_SaveAsTemplatePlugin_t {
    QByteArrayData data[1];
    char stringdata[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SaveAsTemplatePlugin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SaveAsTemplatePlugin_t qt_meta_stringdata_SaveAsTemplatePlugin = {
    {
QT_MOC_LITERAL(0, 0, 20) // "SaveAsTemplatePlugin"
...
const QMetaObject SaveAsTemplatePlugin::staticMetaObject = {
    { &ScActionPlugin::staticMetaObject, qt_meta_stringdata_SaveAsTemplatePlugin.data,
      qt_meta_data_SaveAsTemplatePlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SaveAsTemplatePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SaveAsTemplatePlugin.stringdata))
...
struct qt_meta_stringdata_MenuSAT_t {
    QByteArrayData data[4];
    char stringdata[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MenuSAT_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MenuSAT_t qt_meta_stringdata_MenuSAT = {
    {
QT_MOC_LITERAL(0, 0, 7), // "MenuSAT"
QT_MOC_LITERAL(1, 8, 10), // "RunSATPlug"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "ScribusDoc*"

    },
    "MenuSAT\0RunSATPlug\0\0ScribusDoc*"
};
#undef QT_MOC_LITERAL
...
const QMetaObject MenuSAT::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MenuSAT.data,
      qt_meta_data_MenuSAT,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_MenuSAT.stringdata))
