...
struct qt_meta_stringdata_Scribus12FormatImpl_t {
    QByteArrayData data[1];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Scribus12FormatImpl_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Scribus12FormatImpl_t qt_meta_stringdata_Scribus12FormatImpl = {
    {
QT_MOC_LITERAL(0, 0, 19) // "Scribus12FormatImpl"
...
const QMetaObject Scribus12FormatImpl::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Scribus12FormatImpl.data,
      qt_meta_data_Scribus12FormatImpl,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Scribus12FormatImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Scribus12FormatImpl.stringdata))
