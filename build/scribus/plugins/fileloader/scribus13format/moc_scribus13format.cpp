...
struct qt_meta_stringdata_Scribus13Format_t {
    QByteArrayData data[1];
    char stringdata[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Scribus13Format_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Scribus13Format_t qt_meta_stringdata_Scribus13Format = {
    {
QT_MOC_LITERAL(0, 0, 15) // "Scribus13Format"
...
const QMetaObject Scribus13Format::staticMetaObject = {
    { &LoadSavePlugin::staticMetaObject, qt_meta_stringdata_Scribus13Format.data,
      qt_meta_data_Scribus13Format,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Scribus13Format::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Scribus13Format.stringdata))
