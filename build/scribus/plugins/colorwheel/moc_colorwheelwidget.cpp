...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorWheel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 6), // "button"
QT_MOC_LITERAL(4, 27, 5) // "point"

    },
    "ColorWheel\0clicked\0\0button\0point"
};
...
void ColorWheel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ColorWheel::*_t)(int , const QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorWheel::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ColorWheel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ColorWheel.data,
...
void *ColorWheel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ColorWheel.stringdata))
