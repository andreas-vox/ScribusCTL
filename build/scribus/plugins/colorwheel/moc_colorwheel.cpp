...
struct qt_meta_stringdata_ColorWheelPlugin_t {
    QByteArrayData data[1];
    char stringdata[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ColorWheelPlugin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ColorWheelPlugin_t qt_meta_stringdata_ColorWheelPlugin = {
    {
QT_MOC_LITERAL(0, 0, 16) // "ColorWheelPlugin"
...
const QMetaObject ColorWheelPlugin::staticMetaObject = {
    { &ScActionPlugin::staticMetaObject, qt_meta_stringdata_ColorWheelPlugin.data,
      qt_meta_data_ColorWheelPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ColorWheelPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ColorWheelPlugin.stringdata))
