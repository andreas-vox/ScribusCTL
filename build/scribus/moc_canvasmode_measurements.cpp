...
struct qt_meta_stringdata_MeasurementsMode_t {
    QByteArrayData data[3];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MeasurementsMode_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MeasurementsMode_t qt_meta_stringdata_MeasurementsMode = {
    {
QT_MOC_LITERAL(0, 0, 16), // "MeasurementsMode"
QT_MOC_LITERAL(1, 17, 9), // "setActive"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "MeasurementsMode\0setActive\0"
};
...
const QMetaObject MeasurementsMode::staticMetaObject = {
    { &CanvasMode::staticMetaObject, qt_meta_stringdata_MeasurementsMode.data,
      qt_meta_data_MeasurementsMode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MeasurementsMode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MeasurementsMode.stringdata))
